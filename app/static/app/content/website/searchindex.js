...
function SearchDatabase()
{
   ...
   this[database_length++] = new SearchPage("http://www.yourwebsite.com/post.html", "Lukyanov Blog - Название статьи", "lukyanov blog Название статьи Текст nbsp ыавоыовжлдао лдоывлд олдоы валд олдыовадлоывываыв оывао длывоалд Дата публикации ", "");
